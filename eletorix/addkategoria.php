...
if (isset($_SESSION['userId'])) {
    ...
    $sql ="INSERT INTO kategoria (kategorianimi, kategoriakuvaus) VALUES('$nimi', '$kuvaus');";
    $affected_rows = $db->exec("$sql");

    echo "<div class='muokkaa'>" ;  
    echo "<div class='ilmoitus'>" ; 
    echo "Kategoria lisätty onnistuneesti. <br>Kategorian nimi: " . $nimi . "<br> Kategoriankuvaus: " . $kuvaus;
